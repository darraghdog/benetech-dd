...
cfg.train_df = '/mount/benetech/data/synthetic/train_folded_v03_icdar22v07_dot_hist.csv'
cfg.icdar_folder = "/raid/train_icdar22v07/"
cfg.synth_folder = "/raid/dot_v1_converted/"
cfg.hist_folder = "/raid/hist_converted/"


# cfg.pubmed_pseu_bar_df = f'/mount/benetech/data/pubmed/pseudo_v04_bar_line.csv.zip'
...
cfg.pretrained_weights = '/mount/benetech/models/cfg_ch_15d/fold0/checkpoint_last_seed125689.pth'
...
# DATASET
cfg.dataset = "ds_dh_08ZK_aug2_dot_fix_h"
...
#EVAL
cfg.metric = 'metric_dh_2i_dot_fix'
cfg.calc_metric = True
cfg.simple_eval = False
# augs & tta

# Postprocess
cfg.post_process_pipeline =  "pp_dh_08O_fix"
# augs & tta
