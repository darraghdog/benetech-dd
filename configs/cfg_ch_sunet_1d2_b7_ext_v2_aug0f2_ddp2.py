...
cfg.data_folder = f"/raid/scatter_kp_images_ext_v3/images/"
cfg.mask_folder = f"/raid/scatter_kp_images_ext_v3/masks/"

cfg.train_df = f'/mount/benetech/data/train_folded_v05c_scatter_v2.csv'
